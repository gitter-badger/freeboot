...
public class RestfulControllerTemplate
{
  ...
  protected final String TEXT_19 = ");" + NL + "    }" + NL + "     " + NL + "    @RequestMapping(value=\"/edit/{id}\", method=RequestMethod.GET)" + NL + "    public String edit";
  protected final String TEXT_20 = "Page(@PathVariable int id, Model model) {" + NL + "        model.addAttribute(\"";
  protected final String TEXT_21 = "\", ";
  protected final String TEXT_22 = "Service.get";
  protected final String TEXT_23 = "ById(id));" + NL + "        return \"";
  protected final String TEXT_24 = "/edit-";
  protected final String TEXT_25 = "\";" + NL + "    }" + NL + "     " + NL + "    @RequestMapping(value=\"/edit/{id}\", method=RequestMethod.PUT, " + NL + "            produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)" + NL + "    @ResponseBody" + NL + "    public ";
  protected final String TEXT_26 = " edit";
  protected final String TEXT_27 = "(@PathVariable int id, " + NL + "            @RequestBody ";
  protected final String TEXT_28 = " ";
  protected final String TEXT_29 = ") {";
  protected final String TEXT_30 = NL + "        ";
  protected final String TEXT_31 = ".setId(id);" + NL + "        return ";
  protected final String TEXT_32 = "Service.update";
  protected final String TEXT_33 = "(";
  protected final String TEXT_34 = ");" + NL + "    }" + NL + "     " + NL + "    @RequestMapping(value=\"/delete/{id}\", method=RequestMethod.DELETE, " + NL + "            produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)" + NL + "    @ResponseBody" + NL + "    public void delete";
  protected final String TEXT_35 = "(@PathVariable int id) {";
  protected final String TEXT_36 = NL + "        ";
  protected final String TEXT_37 = "Service.delete";
  protected final String TEXT_38 = "(id);" + NL + "    }" + NL + "     " + NL + "    @RequestMapping(value=\"\", method=RequestMethod.GET," + NL + "            produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)" + NL + "    @ResponseBody" + NL + "    public List< ";
  protected final String TEXT_39 = " > all";
  protected final String TEXT_40 = "() {" + NL + "        return ";
  protected final String TEXT_41 = "Service.getAll";
  protected final String TEXT_42 = "();" + NL + "    }" + NL + "     " + NL + "    @RequestMapping(value=\"\", method=RequestMethod.GET)" + NL + "    public String all";
  protected final String TEXT_43 = "Page(Model model) {" + NL + "        model.addAttribute(\"";
  protected final String TEXT_44 = "List\", all";
  protected final String TEXT_45 = "());" + NL + "        return \"";
  protected final String TEXT_46 = "/all-";
